    ...
    <div>
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
          <a class="navbar-brand nav-link text-white" aria-current="page" href="index.php">Home</a>
      ...
      <div class="row">
        <?php foreach ($products as $product): ?> 
          <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
            <div class="card cards w-100 my-2 shadow-2-strong">
...
<section class="mt-5 mb-4">
  <div class="container">
    <div class="row gy-4">
      <div class="col-lg-6">
        <div class="cards card-banner bg-gray h-100" style="
                                                      min-height: 200px;
                                                      background-size: cover;
      ...
      <div class="col-lg-6">
        <div class="row mb-3 mb-sm-4 g-3 g-sm-4">
          <div class="col-6 d-flex">
            <div class="card cards w-100 rounded" style="
                                                    min-height: 200px; 
        ...
        <!-- row.// -->
        <div class="card cards bg-success" style="min-height: 200px;">
          <div class="card-body">
